			...
			<div class=" main-content-area">
				...
				<div class="wrap-iten-in-cart">
					...
					<ul class="products-cart">
						...
						<li class="pr-cart-item">
							...
							<div class="delete">
								<a href="#" wire:click.prevent="deleteQuantity('{{ $item->rowId }}')" class="btn btn-delete" title="">
				...
				<div class="summary">
					...
					<div class="update-clear">
						<a class="btn btn-clear" href="#" wire:click.prevent="deleteAllQuantity()">Clear Shopping Cart</a>
